...
<body>
	<div class="top-header" id="header">
		<div class="wrap">
			...
			<div class="top-header-right">
				<ul>
					<li><a class="face"
						href="https://www.facebook.com/?stype=lo&jlou=Afc6YMN54Kgo9Vemox7Ug8yzhXO2IcW1WWhJKOy0x_z6mnN_dxJOnKyJMfCeZKU1K63IHiCEgEqDv_KAmTP-B1E4MkvZ-dqqrJp6dg-BjtpMWg&smuh=12705&lh=Ac_gp2CZM1OE7Fpr"><span>
						</span></a></li>
					<li><a class="twit" href="https://twitter.com/?lang=en"><span>
						</span></a></li>
					<li><a class="pin" href="logOutPage" method="POST"><span>
						</span></a></li>
					<div class="clear"></div>
				</ul>
			</div>
	...
	<link rel="stylesheet" type="text/css"
		href="media/compressed/css/home.min.css" />
	<div id="how-title">
	...
	<div id="content">
		...
		<div id="how-container" class="hideme">
			<div class="circle">
				...
				<p></p>
				<p>
					Wherever. Whenever. <br />From half an hour to half a year, we
					know that journeys come in all shapes and sizes.
				</p>
				<div class="icon">
					<img src="media/img/home/justpark/icon-glass-large.png"
						alt="Find cheap parking" width="100" height="75" />
				</div>
			</div>
			<div class="circle">
				<h4>Book</h4>
				...
				<div class="icon">
					<img src="media/img/home/justpark/icon-calendar.png"
						alt="Parking peace of mind" width="100" height="75" />
				</div>
			</div>
			<div class="circle">
				<h4>Park</h4>
				<p></p>
				<p></p>
				<p>Park your vehicle. Carry on with your day. No driving in
					circles and no parking nightmares.</p>
				<div class="icon">
					<img src="media/img/home/justpark/icon-car.png" alt="" width="100"
						height="75" />
				</div>
			</div>
			<div class="clear"></div>
		...
		<div id="benefit-container" class="hideme">
			<div class="graph">
				<img src="media/img/home/justpark/graph/pound.png" alt="Earn money"
					width="23" height="39" /> <img
					src="media/img/home/justpark/graph/bar-meter.png"
					alt="Parking meter" width="125" height="220" class="bar-meter" />
				<img src="media/img/home/justpark/graph/bar-park.png"
					alt="JustPark logo" width="125" height="96" class="bar-park" /> <img
					src="media/img/home/justpark/graph/graph-lines.png"
					alt="Parking stats" width="405" height="230" />
				<div class="graph-caption">
					Up to 70% cheaper<br />than<br />on-street parking
				</div>
			</div>
			<div class="benefit">
				<h4>Save money</h4>
				<img src="media/img/home/justpark/icon-piggy.png"
					alt="Save Money with JustPark" width="81" height="90" />
				<div class="copy">
					<p>On average, parking spaces booked through Easy Park cost
						less than half the price of the nearest on-street alternative.
						With central locations available for as little as 50/= for 24
						hours, you wont want to park with anyone else.</p>
				</div>
			</div>
			<div class="benefit">
				<h4>No parking tickets</h4>
				<img src="media/img/home/justpark/icon-no.png"
					alt="No parking tickets" width="81" height="90" />
				<div class="copy">
					<p>Our drivers love being able to park without the fear of
						traffic wardens and parking tickets. A parking ticket is issued by
						a System and lot of money and stress saved.</p>
				</div>
			</div>
			<div class="benefit">
				<h4>Peace of mind</h4>
				<img src="media/img/home/justpark/icon-smile.png"
					alt="Peace of Mind" width="81" height="90" />
				<div class="copy">
					<p>Pull up at your destination safe in the knowledge that a
						reserved space will be waiting for you. Check out reviews left by
						past drivers before booking and extend your reservation at the tap
						of a button.</p>
				</div>
			</div>
		</div>
