			...
			<div class="row">
				...
				<div class="col-sm-2">
					<button type="button" class="btn btn-primary" data-toggle="modal"
						data-target=".bs-example-modal-lg1">Add Payment Details</button>
					<br> <br> <br>
					<button type="button" class="btn btn-primary" data-toggle="modal"
						data-target=".bs-example-modal-lg">Withdrawal Details</button>
				</div>
				<div class="col-sm-8">
					<h2>
						<b>Transactions</b>
					...
					<form class="form-horizontal" method="post">
						<div class="form-group ">
							<label class="control-label col-sm-2 requiredField" for="date">
								Transaction Dates -: </label>
							<div class="col-sm-6">
								<div class="input-group">
									<input class="form-control" id="FromDate" name="date"
										placeholder="MM/DD/YYYY-From Date" type="text" />
								</div>
								<span> <br>
								</span>
								<div class="input-group">
									<input class="form-control" id="ToDate" name="date"
										placeholder="MM/DD/YYYY-To Date" type="text" />
								</div>
							</div>
						</div>
						<div class="form-group">
							<div class="col-sm-10 col-sm-offset-2">
								<button type="button" class="btn btn-info"
									data-toggle="collapse" data-target="#demo">Submit</button>
							</div>
						</div>
					</form>
				...
				<div class="modal-content">
					<div class="bs-example">
						...
						<form class="form-horizontal" method="post"
							action="../BankServlet">
							<div class="form-group">
								<label class="control-label col-xs-4"><img
									src="../images/download.jpg" class="img-circle"
									alt="Cinque Terre" width="50" height="40"></label>
								<div class="col-xs-4">
									<h5>
							...
							<div class="form-group">
								<label class="control-label col-xs-4" for="inputName">Name
									on Card:</label>
								<div class="col-xs-2">
							...
							<div class="form-group">
								<label class="control-label col-xs-4" for="inputCardNumber">Card
									Number:</label>
								<div class="col-xs-4">
									<input type="password" class="form-control"
										name="inputCardNumber" placeholder="Card Number" required>
									<h6>The number on the front of your credit card</h6>
								</div>
								<div class="col-xs-2">
									<img src="../images/master.jpg" class="img" alt="Cinque Terre"
										width="100" height="40">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label class="control-label col-xs-4" for="HouseName">House
									Name/No:</label>
								<div class="col-xs-4">
							...
							<div class="form-group">
								<label class="control-label col-xs-4" for="StreetAddress">Street
									Name:</label>
								<div class="col-xs-4">
									<input type="tel" class="form-control" name="StreetAddress"
							...
							<div class="form-group">
								<div class="col-xs-offset-4 col-xs-4">
									<label class="checkbox-inline"> <input type="checkbox"
										value="agree"> I agree to the <a href="#">Terms
											and Conditions</a>.
									</label>
								</div>
							</div>
							...
							<div class="form-group">
								<div class="col-xs-offset-4 col-xs-6">
									<input type="submit" class="btn btn-success"
										value="Verify payment details"> <input type="reset"
					...
					<div class="bs-example">
						...
						<form class="form-horizontal" method="post"
							...
							<div class="form-group">
								...
								<div class="col-xs-5">
									<h5>
										<b>Add your preferred withdrawal method below.</b>
									</h5>
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-xs-4" for="BankName">Bank
									Name:</label>
								<div class="col-xs-5">
							...
							<div class="form-group">
								<label class="control-label col-xs-4" for="inputCardNumber">Account
									Number:</label>
								<div class="col-xs-5">
							...
							<div class="form-group">
								...
								<div class="col-xs-5">
									<h5>
										<b>Account holder details</b>
									</h5>
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-xs-4" for="inputName">Account
									Holder Name:</label>
								<div class="col-xs-2">
									<input type="text" class="form-control" name="inputFName"
										placeholder="session value">
