				...
				<form name="registation" action="../RegServlet" method="post"
					...
					<div class="modal-body">
						<div class="external-logins">
							<p>
								<a data-href="../auth/facebook/"
									track="click:registration:signup-facebook" href="#"
									class="btn btn-large btn-fb btn-fixed-size fb-connect"><i
									class="glyphicons icon-facebook"></i> Continue with Facebook</a>
							</p>
							<p>
   ...
   <div class="controls">
        ...
        <p class="help-block">Please choose a secure password (min. 6 characters)</p>
							...
							<div class="form-group control-group required">
								...
								<div class="controls">
									<input type="text" value="" class="phorm_field_text"
